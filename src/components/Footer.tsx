        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
                              <p className="mb-2">Via Cantonale 15</p>
                <p className="mb-2">6918 Lugano, Svizzera</p>
              <p className="mb-2">Email: info@3dmakes.ch</p>
              <p className="mb-2">Tel: +41 76 266 03 96</p>
            </address>
          </div>
        </div>
